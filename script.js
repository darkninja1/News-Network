var head1 = ["Blocking Systems in MCPS","Drone Cape Henlopen","Unblocked Games",'Want to join the News Network?'];
var type = ['pic','vid','pic','pic'];
var img1 = ['pics/blocked2.png','pics/drone1.png','pics/roll1.png','pics/unnamed.webp'];
