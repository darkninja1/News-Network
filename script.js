var head1 = ["Blocking Systems in MCPS","Drone Cape Henlopen","Unblocked Games and Stuff",'Want to join the News Network?','Covid-19 Updates','Multiplayer TicTacToe'];
var type = ['pic','vid','pic','pic','link','link'];
var img1 = ['pics/blocked2.png','pics/drone1.png','pics/roll1.png','pics/north.jpg','pics/covid-19.jpg','pics/ttt1.png'];
var head2 = ['Have you Every wondered how games are blocked at school(MCPS)?','Sweet view from a $30 drone','Want to play games that are still unblocked?','Join us at lunch to work on articals at MBHS','See the latest covid-19 statistics','Multiplayer TicTacToe created by me the writer'];
...
var date1 = ['December 16, 2021','June 23, 2021','December 17, 2021','December 17, 2021','January 11, 2022','January 11, 2022'];
var links = ["","","","","https://covid-19.webteamone.repl.co","https://tictactoe.dominikhonzak.repl.co/"];
